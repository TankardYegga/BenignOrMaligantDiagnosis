...
from resnet50_plus import Net2
...
if __name__ == '__main__':
    ...
    # model = Net2(model_ft)
    # model = Net2(model_ft, num_mid_feats=1000)
    model = Net2(model_ft, num_mid_feats=1000)
    num_final_feats = 10
    ...
    #                     use_gpu, image_datasets, model_name='resnet50_21_pretrain',
    #                     pkl_file=r'', img_feats_dict=img_feats_dict)
    model = train_model(model, image_dataloaders, criterion, optimizer, lr_scheduler, num_epochs,
                        use_gpu, image_datasets, model_name='resnet50_2_1024_pretrain',
                        pkl_file=r'', img_feats_dict=img_feats_dict)