...
@torch.no_grad()
def test_model_w_vgg(net, test_dataloader, img_datasets, use_gpu, img_feats_dict, save_path, phase='test'):
    ...
    vgg_model.load_state_dict(
        torch.load('/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/pkls_vgg_19_pretrain_100/' \
                   'vgg_19_pretrain_epoch_22_tensor(0.6395, device=\'cuda:4\')_best.pkl'))
...
if __name__ == '__main__':
    ...
    # model = Net2(model, num_mid_feats=256)
    # model = models.densenet121(pretrained=True)
    # model = Net4(model)
    model = models.densenet121(pretrained=True)
    model = Net8(model)
    ...
    # pretrained_file = '/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/pkls_densenet121_w_trfm_fusion_2_cv_10_200/' \
    #             '1_densenet121_w_trfm_fusion_2_cv_10_epoch_33_tensor(0.9286, device=\'cuda:0\')_best.pkl'
    #
    # save_path = fine_tune(model, dataloader['train'], img_datasets, num_epochs, criterion, optimizer, scheduler,
    #                       use_gpu, model_dir='pkls_densenet121_w_trfm_fusion_2_cv_10_200',
    #                       model_name="densenet121_w_trfm_fusion_2_cv_10", img_feats_dict=img_feats_dict,
    #                       pretrained_file=pretrained_file)

    # save_path = '/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/pkls_densenet121_w_trfm_fusion_2_cv_10_200/' \
    #             '1_densenet121_w_trfm_fusion_2_cv_10_epoch_33_tensor(0.9286, device=\'cuda:0\')_best.pkl'
    # test_model(model, dataloader['train'], img_datasets, use_gpu, img_feats_dict, save_path, phase='train')
    # test_model(model, dataloader['test'], img_datasets, use_gpu, img_feats_dict, save_path, phase='test')

    save_path = '/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/pkls_densenet121_net8_cv_10_200/' \
                '1_densenet121_net8_cv_10_epoch_21_tensor(0.9524, device=\'cuda:3\')_best.pkl'
    test_model_w_vgg(model, dataloader['test'], img_datasets, use_gpu, img_feats_dict, save_path, phase='test')
