...
def train_model(i, net, train_paths, train_labels, val_paths, val_labels,
    ...
    vgg_model.load_state_dict(torch.load('/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/pkls_vgg_19_pretrain_100/'\
...
def k_fold_train(k, train_img_path, train_img_label):
    ...
    for i in range(start_fold_number, end_fold_number):
        ...
        model_name = 'densenet121_net8_cv_' + str(k)
...
if __name__ == '__main__':
    ...
    train_img_paths, train_img_labels = get_available_data_by_order(data_dir='/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/data_corrected/shuffled_merged_data')
    k = 10
