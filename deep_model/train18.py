...
from convnext_ori import convnext_tiny
from transfer_dict import transfer_model
...
def k_fold_train(k, train_img_path, train_img_label):
    ...
    for i in range(start_fold_number, end_fold_number):
        ...
        transfer_model("convnext_tiny_1k_224_ema.pth", model)
        # model.load_state_dict(torch.load("convnext_tiny_1k_224_ema.pth", map_location=lambda storage, loc: storage))
        ...
        # model_name = 'covnext_ori_cv_' + str(k)
        model_name = 'covnext_ori_pretrained_cv_' + str(k)
