...
"""
@File    : train22.py.py
@Time    : 2/24/2022 10:48 AM
@Author  : Liuwen Zou
@Email   : levinforward@163.com
@Software: PyCharm

训练VGG网络来分类良性和恶性的拓扑分割结果
"""
...
from densenet_plus import Net2
...
def get_normalized_mean_and_std():
    ...
    image_datasets = {x: CustomData(img_path='/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/data_corrected/fixed_split_topo_mask/' + x,
...
if __name__ == '__main__':
    ...
    fc_list = [model.classifier[i] for i in range(6)]
    ...
    model.classifier = torch.nn.Sequential(*fc_list)
    print(model)
    ...
    model = train_model(model, image_dataloaders, criterion, optimizer, lr_scheduler, num_epochs,
                        use_gpu, image_datasets, model_name='vgg_19_pretrain',
                        pkl_file=r'')
