...
from train_corrected import test_model_concat_fusion, test_model_corrected, test_model_w_loss_corrected, train_model_concat_fusion, train_model_corrected, train_model_w_loss_corrected
...
# ##################################################################################
    ...
    # model_name = 'experim_4_efficient_paper'
...
##################################################################################
    ...
    # model_name = 'experim_4_alexnet_paper2'
...
#################################################################################
    ...
    # model_name = 'resnet13_change_pool3_paper'
    # model = ResNet13_Change_Pool3(num_mid_feats=32, num_classes=2)
...
##############################################################################
    ...
    # num_trans_dim = 100
    # model_name = 'DenseNet2_W_WeightPool2_' + str(num_trans_dim) + '_paper2' 
...
#######################################################################################
    ...
    save_path = '/mnt/520_v2/lxy/BenignOrMaligantDiagnosis/deep_model/experim_4_densenet121_paper2_1.0_2/experim_4_densenet121_paper2_1.0_2_epoch_24_0.8713450292397661_0.8372093023255814.pkl'
