...
"""
@File    : train23.py
@Time    : 3/9/2022 2:35 PM
@Author  : Liuwen Zou
@Email   : levinforward@163.com
@Software: PyCharm

densenet121 + 额外信息 + trfm信息融合  +  在固定的8:2数据上进行验证
"""
...
def train_model(model, dataloader, criterion, optimizer, scheduler,
    ...
    dir_path = "/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/" + model_pkls_name
    ...
    for epoch in range(start_epoch + 1, num_epochs):
        ...
        for phase in running_stages:
            ...
            if phase == 'train':
                # print('train yes')
                save_path = '/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/' + model_pkls_name + '/' + \
    ...
    torch.save(best_model_wts, '/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/'  + model_pkls_name + '/' + str(model_name) \
...
def get_normalized_mean_and_std():
    ...
    image_datasets = {x: CustomData(img_path='/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/data_corrected/fixed_split_data/' + x,
...
if __name__ == '__main__':
    ...
    val_data_loaders = DataLoader(image_datasets['val'], shuffle=True, batch_size=5,
                                  num_workers=1)
    # image_dataloaders = {'train': train_data_loaders, 'val': val_data_loaders}
    image_dataloaders = {'train': train_data_loaders, 'val': train_data_loaders}

    # for i, (paths, inputs, labels) in enumerate(image_dataloaders['train']):
    #     print("paths:", labels.shape)
    #     print("inputs:", inputs.shape)
    #
    # for i, (paths, inputs, labels) in enumerate(image_dataloaders['val']):
    #     print("inputs:", inputs.shape)
    #     print("labels:", labels.shape)
    #
    # pass
    ...
    #                     pkl_file=r'/mnt/520/lijingyu/lijingyu/zlw/ExtraCode/deep_model2/pkls_manual_densenet_100_1/manual_densenet_epoch_76_best.pkl')
    model = train_model(model, image_dataloaders, criterion, optimizer, lr_scheduler, num_epochs,
                        use_gpu, image_datasets, model_name='densenet121_net9_pretrain',
                        pkl_file=r'')
